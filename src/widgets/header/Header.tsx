...
function Header() {
  return (
    <header className="relative flex flex-row items-center justify-between px-15 pt-16 pb-6">
      <MenuButton />
      <h1 className="fixed translate-[-50%] left-[50%] top-[8%]">
        <a href="#">
          <svg width="88" height="36" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 156">
